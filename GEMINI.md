...
14. **Never suppress warnings or errors**: Never suppress warnings (e.g., no `suppressHydrationWarning`), ignore errors, or hide diagnostic outputs. Diagnose and fix the underlying root cause directly.
